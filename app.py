...
st.set_page_config(page_title="HidroSed SedGran v3.7.1 Correctivas Plus", page_icon="🌊", layout="wide")
...
st.sidebar.title("HidroSed SedGran v3.7.1")
st.sidebar.caption("Centro de control hidráulico-hidrológico · QA · 3D · trazabilidad · hotfix imports")
for k, label in [
...
with tabs[8]:
    ...
    if has("sections_df") and has("section_points_df"):
        ...
        memoria_txt = generate_calculation_memory_text({
            ...
            "dictamen": "Memoria automática generada por HidroSed SedGran v3.7.1 Correctivas. Debe revisarse y firmarse por profesional responsable.",
        })
        st.download_button(
